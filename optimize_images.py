...
FOLDERS = {
    "product": {"prefix": "product", "count": 5},  # Also used as hero
    "testimonials": {
        "prefix": "testimonial",
        "count": 25,
    },  # Features, Secrets, Reviews
    "order-bump": {"prefix": "order-bump", "count": 2},  # Order bump product
    "founder": {"prefix": "founder", "count": 1},  # Founder story only
    "comparison": {"prefix": "comparison", "count": 2},  # Before/after
    "universal-assets": {"prefix": "universal", "count": 10},  # Trust badges, logos
}
