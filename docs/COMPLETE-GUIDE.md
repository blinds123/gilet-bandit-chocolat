...
```
images/
├── product/           → product-01.png to product-05.png
├── testimonials/      → testimonials-01.png to testimonials-25.png
├── comparison/        → comparison-01.png (boring), comparison-02.png (your product)
├── order-bump/        → order-bump-01.png
└── universal-assets/  → support-badge.png, size-chart-hero.png
```

### Step 2: Update Product Info
Edit `sections/05-main-product.html`:
- Search/replace `Auralo Leopard Sequin Maxi Skirt` with your product name
