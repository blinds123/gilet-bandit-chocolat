...
Generate 35 images with TikTok-style comment bubbles for social proof.
...
| **Comparison** | 2 | None | N/A |
| **Founder** | 1 | None | N/A |
| **Order Bump** | 1 | None | N/A |
| **TOTAL** | **35** | **42 bubbles total** | |
...
## ⚖️ COMPARISON PHOTOS (2 Images)

### NO TikTok bubbles on comparison images!

### Image 1: BAD PRODUCT (Competitor)

```
Professional studio photoshoot with clean white backdrop, even lighting. A [MODEL DESCRIPTION] stands facing the camera with an uncomfortable, frustrated expression. She wears [CHEAP COMPETITOR PRODUCT] - bulky, unflattering, cheap-looking. [DESCRIBE WHY IT'S BAD]. She looks squeezed and uncomfortable. A large red X mark appears in the top-right corner of the image. Studio lighting, white background. This is THE OLD way - [PAIN POINT]. 800x1200px vertical.
```

### Image 2: GOOD PRODUCT (Your Product)

```
Professional studio photoshoot with clean white backdrop, even lighting. A [MODEL DESCRIPTION] stands facing the camera with a confident, radiant smile. She wears [YOUR PRODUCT] - [DESCRIBE PREMIUM QUALITIES]. She looks comfortable and confident. A large green checkmark appears in the top-right corner of the image. Studio lighting, white background. This is THE NEW way - [BENEFIT]. 800x1200px vertical.
```
...
*This document must be read before any image generation begins.*
...
#### 1. Nano Banana (generate_image tool) - PRIMARY

If you have the `generate_image` tool available (Gemini/Antigravity):
...
#### 2. Google Whisk - FALLBACK

If generate_image is not available or fails:
...
Save images to:
```
images/product/product-01.png through product-06.png
images/testimonials/testimonial-01.png through testimonial-25.png
images/comparison/comparison-bad.png, comparison-good.png
images/founder/founder-01.png
images/order-bump/order-bump-01.png
```
...
**Total: 35 images with 42 TikTok comment bubbles**
...
- [ ] 2 comparison photos generated (no bubbles)
