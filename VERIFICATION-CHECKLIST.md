...
- [x] phases/2-images.md - 35 image specifications
...
- [x] images/comparison/ - 2 comparison images (bad vs good)
...
- [x] Image prompt generation (35 hyper-detailed prompts)
...
- [x] Phase 2: Generate 35 image prompts (5 min)
